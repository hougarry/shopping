        ...
        <div class="footer">
          <div class="ng-promise-box">
            <div class="ng-promise">
              <p class="text">
                <a class="icon1" href="javascript:;">15天无理由退换货</a>
                <a class="icon2" href="javascript:;">满40元全场免邮</a>
                <a class="icon3" style="margin-right: 0" href="javascript:;">100%品质保证</a>
              </p>
            </div>
          </div>
          <div class="github">
            <a href="https://github.com/hougarry" target="_blank">
          ...
          <div class="mod_help">
            ...
            <p class="coty">商城版权所有 &copy; 2024</p>
          </div>
        </div>
      </el-footer>
      <!-- 底栏容器END -->
