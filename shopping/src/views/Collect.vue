<template>
    <div class="collect">
      ...
      <div class="content">
        <div class="goods-list" v-if="collectList.length>0">
          ...
          <MyList :list="collectList" :isDelete="true" @delete-item="handleDeleteCollectItem"></MyList>
  ...
  export default {
    ...
    methods: {
      handleDeleteCollectItem(productId) {
        this.collectList = this.collectList.filter(item => item.productId !== productId);
      },
    }
