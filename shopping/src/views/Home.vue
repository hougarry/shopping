 ...
 <template>
        ...
        <div class="main">
          ...
          <div class="phone">
            ...
            <div class="box-bd">
              ...
              <div class="list">
                ...
                <MyList :list="phoneList" :isMore="true" @delete-item="handleDeletePhoneItem" />
          ...
          <div class="phone">
            ...
            <div class="box-bd">
              ...
              <div class="list">
                <MyList :list="miTvList" :isMore="true" @delete-item="handleDeleteMiTvItem" />
              </div>
            </div>
          </div>
          <!-- 电视商品展示区域END -->
          ...
          <div class="accessory" id="promo-menu">
            ...
            <div class="box-bd">
              ...
              <div class="list">
                <MyList :list="accessoryList" :isMore="true" @delete-item="handleDeleteAccessoryItem" />
              </div>
            </div>
          </div>
          <!-- 配件商品展示区域END -->
  ...
  // Add new methods here for deletion handling
  handleDeletePhoneItem(productId) {
    this.phoneList = this.phoneList.filter(item => item.productId !== productId);
  },
  handleDeleteMiTvItem(productId) {
    this.miTvList = this.miTvList.filter(item => item.productId !== productId);
  },
  handleDeleteAccessoryItem(productId) {
    this.accessoryList = this.accessoryList.filter(item => item.productId !== productId);
  }
}
